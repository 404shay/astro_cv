...
import { l as levels, g as getEventPrefix, e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_RZp0ZlrJ.mjs';
...
const _page2 = () => import('./pages/articles/legal-sender-auth.astro.mjs');
const _page3 = () => import('./pages/articles/legal-sender-rep.astro.mjs');
const _page4 = () => import('./pages/certificates/awscloud.astro.mjs');
const _page5 = () => import('./pages/certificates/cyber-network-pro.astro.mjs');
const _page6 = () => import('./pages/contact/email.astro.mjs');
const _page7 = () => import('./pages/contact/github.astro.mjs');
const _page8 = () => import('./pages/contact/linkedin.astro.mjs');
const _page9 = () => import('./pages/contact/researchgate.astro.mjs');
const _page10 = () => import('./pages/contact/wiki.astro.mjs');
const _page11 = () => import('./pages/projects/1nimbus.astro.mjs');
const _page12 = () => import('./pages/projects/2yumepost.astro.mjs');
const _page13 = () => import('./pages/projects/3smarta.astro.mjs');
const _page14 = () => import('./pages/studies/1wgu.astro.mjs');
const _page15 = () => import('./pages/studies/2gsu.astro.mjs');
const _page16 = () => import('./pages/works/work1.astro.mjs');
const _page17 = () => import('./pages/works/work2.astro.mjs');
const _page18 = () => import('./pages/works/work3.astro.mjs');
const _page19 = () => import('./pages/works/work4.astro.mjs');
const _page20 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/about/about.md", _page1],
    ["src/pages/articles/legal-sender-auth.md", _page2],
    ["src/pages/articles/legal-sender-rep.md", _page3],
    ["src/pages/certificates/AWScloud.md", _page4],
    ["src/pages/certificates/cyber-network-pro.md", _page5],
    ["src/pages/contact/email.md", _page6],
    ["src/pages/contact/github.md", _page7],
    ["src/pages/contact/linkedin.md", _page8],
    ["src/pages/contact/researchgate.md", _page9],
    ["src/pages/contact/wiki.md", _page10],
    ["src/pages/projects/1nimbus.md", _page11],
    ["src/pages/projects/2yumepost.md", _page12],
    ["src/pages/projects/3smarta.md", _page13],
    ["src/pages/studies/1wgu.md", _page14],
    ["src/pages/studies/2gsu.md", _page15],
    ["src/pages/works/work1.md", _page16],
    ["src/pages/works/work2.md", _page17],
    ["src/pages/works/work3.md", _page18],
    ["src/pages/works/work4.md", _page19],
...
const _args = {
    "middlewareSecret": "499e6a22-9f37-481e-953c-2b083e4da396",
